        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="properties-service-v">
                    <img src="assets/img/logo.png" alt="admin" class="img-fluid">
                </div>
            </div>
                    ...
                    <div id="faq" class="faq-accordion">
                        <div class="card m-b-0">
                            ...
                            <div id="collapse1" class="card-block collapse">
                                <p>If there’s one thing HGTV has taught us all, it’s this: Real estate is complicated. Whether it’s buying a house, selling one, renovating, building, or managing a property, each different facet of real estate comes with its own set of challenges.</p>
                            </div>
