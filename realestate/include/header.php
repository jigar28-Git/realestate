                ...
                <nav class="navbar navbar-expand-lg navbar-light rounded">
                    ...
                    <div class="navbar-collapse collapse w-100" id="navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item-img deopdown active">          
                                <a class="nav-link dropdown-toggle" href="./admin/register.php">Register</a>
                            </li>

                            <li class="nav-item-img deopdown active">          
                                <a class="nav-link dropdown-toggle" href="http://localhost/realestate/admin/">Login</a>
                            </li>
