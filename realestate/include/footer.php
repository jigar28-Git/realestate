<footer class="footer">
    <div class="container footer-inner">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            Email: <a href="info@propertyhunters.gmail.com">info@propertyhunters.gmail.com</a>
                        </li>
                        <li>
                            Phone: <a href="tel:+0477-85x6-552">+918200 020 676</a>
                        </li>
                    </ul>
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">&copy;  2022 <a href="http://localhost/realestate/index.php" target="_blank">property Hunters</a>. Trademarks and brands are the property of their respective owners.</p>
            </div>
        </div>
    </div>
</footer>
